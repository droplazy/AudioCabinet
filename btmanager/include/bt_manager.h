...
#define BTMGVERSION "Version:4.0.4.20240416"
...
typedef void (*bt_a2dp_sink_stream_cb)(const char *bd_addr, uint16_t channels, uint32_t sampling,
...
enum btmg_at_type {
    BTMG_AT_TYPE_RAW,
    BTMG_AT_TYPE_CMD,
    BTMG_AT_TYPE_CMD_GET,
    BTMG_AT_TYPE_CMD_SET,
    BTMG_AT_TYPE_CMD_TEST,
    BTMG_AT_TYPE_RESP,
    BTMG_AT_TYPE_MAX
};
...
typedef enum {
    ...
    BTMG_HFP_HF_SCO_LINK_CONNECTED,
    BTMG_HFP_HF_SCO_LINK_DISCONNECTED,
} btmg_hfp_hf_connection_state_t;

typedef enum {
    BTMG_HFP_AG_DISCONNECTED,
    BTMG_HFP_AG_CONNECTED,
    BTMG_HFP_AG_CONNECT_FAILED,
    BTMG_HFP_AG_DISCONNEC_FAILED,
    BTMG_HFP_AG_SCO_LINK_CONNECTED,
    BTMG_HFP_AG_SCO_LINK_DISCONNECTED,
...
typedef void (*bt_hfp_hf_connection_state_cb)(btmg_hfp_hf_connection_state_t state);
typedef void (*bt_hfp_ag_connection_state_cb)(btmg_hfp_ag_connection_state_t state);
typedef void (*bt_hfp_at_event_cb)(struct btmg_at_t at_msg);
typedef struct btmg_hfp_callback_t {
    bt_hfp_hf_connection_state_cb hfp_hf_connection_state_cb;
    bt_hfp_ag_connection_state_cb hfp_ag_connection_state_cb;
    bt_hfp_at_event_cb hfp_at_event_cb;
} btmg_hfp_callback_t;
