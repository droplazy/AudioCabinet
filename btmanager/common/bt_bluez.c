...
* Author: BT Team
* Date: 2022.03.12
* Description: establish connection with bluez by dbus.
*/
...
static void *bt_routine(void *arg)
{
    ...
    bt_adapter_set_scan_mode("piscan");

    // bt_adapter_set_max_link_num(3); //XR829 don't need it on high version
    ...
    bt_adapter_set_scan_mode("nopiscan");
